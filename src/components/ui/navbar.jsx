...
export function Navbar() {
  ...
  const [favoritesBounce, setFavoritesBounce] = useState(false);
  const { cart } = useCart();
  ...
  // Animate favorites icon when items are added
  useEffect(() => {
    if (favorites.totalItems > 0) {
      setFavoritesBounce(true);
      const timer = setTimeout(() => setFavoritesBounce(false), 600);
      return () => clearTimeout(timer);
    }
  ...
  const navItems = {
    "Atlier 1": [
      { name: "Shirts", slug: "atlier-1-shirts" },
      { name: "Pants & Shorts", slug: "atlier-1-pants-shorts" },
      { name: "Co-Ord Capsule", slug: "atlier-1-co-ord-capsule" },
      { name: "Lustralis Estate", slug: "atlier-1-lustralis-estate" },
    ],
    "Atlier 2": [
      { name: "Dresses", slug: "atlier-2-dresses" },
      { name: "Tops", slug: "atlier-2-tops" },
      { name: "Skirts", slug: "atlier-2-skirts" },
      { name: "Co-Ord Capsule", slug: "atlier-2-co-ord-capsule" },
      { name: "Riviera Vastore", slug: "atlier-2-riviera-vastore" },
    ],
  };
  ...
  else if (!isSearchOpen && pathname.startsWith("/favorites"))
    highlight = "heart";
        ...
        >
          <div className="flex justify-between items-center h-20">
                  ...
                  <div className="relative w-6 h-5">
                    <span
                      className={`absolute left-0 w-6 h-0.5 bg-gray-700 transition-all duration-300 ${
                        isMobileMenuOpen ? "top-1/2 -translate-y-1/2" : "top-0"
                      }`}
                    />
                    <span
                      className={`absolute left-0 w-6 h-0.5 bg-gray-700 transition-all duration-300 ${
            ...
            <div className="flex items-center space-x-6">
              ...
              >
                <div
                  className={`relative flex flex-col items-center transition-transform duration-300 ${
                    favoritesBounce ? "scale-110" : "scale-100"
                  }`}
                  ref={iconRefs.heart}
                >
              ...
              >
                <div
                  className={`relative flex flex-col items-center cart-icon transition-transform duration-300 ${
