    ...
    <main className="bg-white min-h-screen flex flex-col items-center px-0 py-0">
      ...
      <div className="w-full flex flex-row justify-center items-start gap-10 max-w-[1240px] mx-auto px-8">
        ...
        <div className="flex flex-col items-start" style={{ width: "760px" }}>
          <AnimatePresence mode="wait">
              ...
              >
                {cart.items.length === 0 ? (
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center w-full">
                    ...
                    <div className="text-[#444] text-base font-normal mb-4">
                      Your cart is empty
                    </div>
                    <Link
                      href="/collections"
                  ...
                  <div className="flex-1 w-full">
                    <div className="flex justify-between items-center mb-6">
                      <h2 className="text-[#222] text-xl font-bold">
                        Shopping Cart
                      </h2>
                    ...
                    <div className="space-y-4 mb-6">
                      {cart.items.map((item) => (
                        <div
                          key={item.key}
                          className="bg-white rounded-lg p-4 shadow-sm border border-[#e5e5df] flex items-center gap-4"
                        >
                          {/* Product Image */}
                          ...
                          <div className="flex-1">
                            <h3 className="font-medium text-[#222] mb-1">
                              {item.name}
                            </h3>
            ...
            {step === 1 && (
              ...
              >
                <div className="flex-1">
                  <div className="text-[#222] text-xl font-bold mb-6">
                    Checkout
                  </div>
                  ...
                  {userInfo && (
                    <div className="mb-8">
                      <h3 className="text-[#222] text-lg font-semibold mb-4">
                        Your Information
                      </h3>
                      ...
                      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6 flex items-start gap-3">
                        ...
                        <div className="text-sm text-orange-800">
                          ...
                          <p>
                            You can modify your shipping and billing addresses
                            in the{" "}
                            <Link
                              href="/account"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div className="bg-white rounded-lg p-4 border border-[#e5e5df]">
                          <h4 className="font-semibold text-[#222] mb-3">
                            Contact Information
                          </h4>
                      ...
                      <div className="space-y-4 mb-6">
                        {cart.items.map((item) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <h4 className="font-medium text-[#222] text-sm">
                                {item.name}
                              </h4>
                              <p className="text-xs text-[#666]">
            ...
            {step === 2 && (
              ...
              >
                <div className="flex-1 flex flex-col items-center justify-center">
                  <div className="text-[#222] text-xl font-bold mb-4 text-center">
                    Confirmation
                  </div>
                  <div className="text-[#444] text-base font-normal mb-4 text-center max-w-md">
                    Your order is almost complete! Click below to proceed to
                    secure payment.
                  </div>
        ...
        <div className="flex flex-col gap-0" style={{ width: "370px" }}>
          {/* The Orange Box */}
          <div
            className="bg-gray-100 rounded-md p-6 flex flex-col shadow-sm border border-[#ede9df]"
            style={{ boxShadow: "0 2px 8px 0 rgba(0,0,0,0.03)" }}
          >
            <div
              className="font-bold text-[#222] text-[17px] mb-2 tracking-wide"
            ...
            <div className="flex flex-row items-start gap-5 mt-1">
              <div className="w-24 h-24 aspect-square flex-shrink-0 bg-gray-300 rounded flex items-center justify-center text-gray-400 text-xs select-none">
                Image
              </div>
              <p className="text-[15px] text-[#444] leading-snug pt-1">
          ...
          >
            ...
            <div className="text-[15px] text-[#444] mb-3">
              ...
              <a href="tel:8004414488" className="underline">
                800-441-4488
              </a>
            </div>
            ...
            <div className="flex flex-row justify-between items-start w-full pt-2">
              ...
              <div className="flex flex-col items-center text-[14px] text-[#444] w-1/3">
                <ArrowLeftRight
                  className="h-7 w-7 mb-1 text-[#222]"
                  strokeWidth={1.3}
                />
                <span className="mt-0.5 text-center leading-tight">
                  Returns &<br />
